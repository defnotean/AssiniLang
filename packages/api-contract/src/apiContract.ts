import { z } from "zod";
import { sourceAssetSchema, extractionDraftSchema, languageTypologySchema } from "./publicModels.js";

const aiSessionModeSchema = z.enum(["learner_practice", "elder_review", "programmer_debug"]);
...
export const languagePatchPayloadSchema = z
  .object({
    name: nonEmptyTrimmedStringSchema,
    description: nonEmptyTrimmedStringSchema,
    orthography: nonEmptyTrimmedStringSchema,
...
export const sourceRegistrationPayloadSchema = z
  .object({
...
export const obsidianVaultImportPayloadSchema = z
  .object({
...
export const processSourceOptionsSchema = z
  .object({
...
export const exerciseSubmissionPayloadSchema = z
  .object({
...
export const createAiSessionPayloadSchema = z
  .object({
...
export const prototypeSessionPayloadSchema = z
  .object({
...
export const bulkReviewPayloadSchema = z
  .object({
...
export const governancePayloadSchema = z
  .object({
    languageId: nonEmptyTrimmedStringSchema,
...
export const reviewPolicyPayloadSchema = z
  .object({
...
export const reviewDispositionResolvePayloadSchema = z
  .object({
    resolutionSummary: nonEmptyTrimmedStringSchema
  })
  .strict();

export const reviewDispositionResolveByIdPayloadSchema = reviewDispositionResolvePayloadSchema
  .extend({
...
export const elderCorrectionPayloadSchema = z
  .object({
    languageId: nonEmptyTrimmedStringSchema,
