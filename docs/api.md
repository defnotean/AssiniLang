...
| `GET /languages/:languageId/profile` | Return public linguistic profile data for one language, including phonology, vocabulary, semantic domains, grammar, paradigms, dialect variants with evidence-backed history timelines, discourse examples, teaching sequences, a derived morpheme inventory, the shared synthetic fixture quality floor, and actual-vs-minimum quality checks. |
